...
def test_initialize_and_safe_tool_surface():
 ...
 assert names=={'emporos_status','list_campaigns','get_campaign_snapshot','search_campaign_sources','record_referee_narration','list_gameplay_tool_schemas','execute_gameplay_tool'}
