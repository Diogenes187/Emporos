...
def test_initialize_and_safe_tool_surface():
 ...
 assert names=={'emporos_status','list_campaigns','get_campaign_snapshot','search_campaign_sources','record_referee_narration','list_pending_referee_turns','complete_referee_turn','append_conversation_log_entry','list_conversation_logs','read_conversation_log','list_gameplay_tool_schemas','execute_gameplay_tool','get_adventure_module','create_adventure_module','key_adventure_location','enter_adventure_location','update_adventure_location_state','advance_adventure_exploration'}
