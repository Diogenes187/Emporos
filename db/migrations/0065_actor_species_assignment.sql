CREATE TABLE actor_species_assignment (
    actor_species_assignment_id bigint GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ...
    assignment_kind text NOT NULL CHECK (
        assignment_kind IN ('character_creation','import','player_edit')
    ),
    assigned_at timestamptz NOT NULL DEFAULT clock_timestamp(),
    UNIQUE (actor_id,assignment_revision)
);

CREATE VIEW actor_current_species AS
SELECT DISTINCT ON (assignment.actor_id)
       assignment.actor_species_assignment_id,assignment.actor_id,
       assignment.species_rule_id,assignment.assignment_revision,
       assignment.assignment_kind,assignment.assigned_at
FROM actor_species_assignment assignment
ORDER BY assignment.actor_id,assignment.assignment_revision DESC;

CREATE TABLE cmd_actor_species_assignment_receipt (
    command_id bigint PRIMARY KEY REFERENCES cmd_command(command_id),
    actor_species_assignment_id bigint NOT NULL UNIQUE REFERENCES
