CREATE TABLE cmd_character_creation_completion_receipt (
    ...
    career_stints smallint NOT NULL CHECK (career_stints >= 0),
    benefit_rolls_completed smallint NOT NULL CHECK (
        benefit_rolls_completed >= 0
    )
);
