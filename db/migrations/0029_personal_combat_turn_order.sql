ALTER TABLE enc_personal_combatant
    ADD COLUMN turn_started_this_round boolean NOT NULL DEFAULT false;
...
CREATE TABLE cmd_personal_turn_begin_receipt (
    ...
    initiative_at_start integer NOT NULL,
    dexterity_at_start  smallint NOT NULL CHECK (dexterity_at_start >= 0),
    simultaneous_group_size integer NOT NULL CHECK (simultaneous_group_size > 0),
